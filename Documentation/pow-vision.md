...
1. Download the installer from the POW Dashboard.
...
1. Open **POW Vision** on your desktop. It will display a 6-digit pairing code (e.g., `AB1234`).
2. Open your web browser and log into the main **POW Dashboard**.
3. In the sidebar, click on **Vision Auth** (or navigate to `/vision-auth`).
4. Enter the 6-digit code shown on your desktop app into the web page and click **Authenticate**.
5. Your desktop app will instantly log in and connect to your account!
