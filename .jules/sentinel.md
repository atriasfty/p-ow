...
## 2026-04-23 - Prisma OR Fallback
**Vulnerability:** IDOR via empty string matching in Prisma queries.
**Learning:** Using `|| ""` fallbacks in OR conditions can match unrelated users.
**Prevention:** Use dynamically pushed array elements.
