...
export async function processMilestones(userId: string, serverId: string) {
    try {
        ...
        // 1. Calculate weekly duty time (shifts starting this week)
        ...
        for (const milestone of milestones) {
            ...
            // Debounce: check if we've already SENT a ROLE_ADD for this specific milestone in the last 24h
            // (Note: Since milestones are weekly, they might be re-earned each week)
