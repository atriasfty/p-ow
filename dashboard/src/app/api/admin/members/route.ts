...
export async function GET(req: Request) {
    ...
    try {
        ...
        // This avoids the large OR clause generated by the previous groupBy approach,
        // significantly improving performance and reducing memory usage for large servers.
        const latestShifts = await prisma.shift.findMany({
            where: { serverId, userId: { in: userIds } },
            distinct: ['userId'],
            orderBy: [
                { userId: 'asc' }, // Required first for PostgreSQL when using distinct
                { startTime: 'desc' }
            ],
