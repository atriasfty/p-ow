...
export async function GET(req: Request) {
    ...
    try {
        ...
        // Fetch the single most-recent shift per user using distinct on userId
        // ⚡ Bolt: Optimized by avoiding groupBy + dynamic OR query which causes massive N+1-like inefficiency
