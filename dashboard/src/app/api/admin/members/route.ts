...
export async function GET(req: Request) {
    ...
    try {
        ...
        // ⚡ Bolt: Optimize finding latest shifts by replacing groupBy + OR array with a single distinct query
        // This solves the N+1/large payload query problem and performs much faster
