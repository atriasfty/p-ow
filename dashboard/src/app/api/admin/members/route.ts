...
export async function GET(req: Request) {
    ...
    try {
        ...
        // ⚡ Bolt: Replaced groupBy + OR array anti-pattern with a single distinct query
        // This solves the N+1 problem and avoids the dynamic OR array which can be slow and crash on large sets.
