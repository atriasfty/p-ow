...
export async function GET(req: Request) {
    ...
    try {
        ...
        // Replaced a `groupBy` and massive dynamic `OR` array with a single `distinct` query.
        // Impact: Eliminates the N+1 database bottleneck when processing thousands of members,
        // reducing memory overhead and time-to-first-byte significantly.
        // Fetch the single most-recent shift per user
