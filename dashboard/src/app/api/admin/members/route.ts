...
export async function GET(req: Request) {
    ...
    try {
        ...
        // Fetch the single most-recent shift per user efficiently using distinct and orderBy
        // ⚡ Bolt: Using distinct with orderBy is significantly faster than groupBy + dynamic OR query
