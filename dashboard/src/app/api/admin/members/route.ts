...
export async function GET(req: Request) {
    ...
    try {
        ...
        // ⚡ Bolt Optimization: Replaced two queries (groupBy + findMany with large OR array)
        // with a single findMany using distinct and orderBy to improve performance and avoid scaling issues with large arrays.
