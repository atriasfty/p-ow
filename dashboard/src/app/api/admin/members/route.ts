...
export async function GET(req: Request) {
    ...
    try {
        ...
        // ⚡ Bolt: Optimized query by replacing groupBy + OR array with a single distinct query
        // Expected impact: Removes N+1 style OR conditions, significantly reducing query parsing cost and database load
