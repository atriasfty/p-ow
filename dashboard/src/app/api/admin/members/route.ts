...
export async function GET(req: Request) {
    ...
    try {
        ...
        // ⚡ Bolt: Replaced inefficient groupBy + OR array lookup with a single distinct query
        // This avoids large OR arrays and reduces query overhead by using distinct with an explicit orderBy.
