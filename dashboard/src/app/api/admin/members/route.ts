...
export async function GET(req: Request) {
    ...
    try {
        ...
        // ⚡ Bolt: Replaced expensive groupBy + findMany(OR) with a single distinct query
        // This avoids ConnectorErrors with large OR arrays and significantly improves query performance
