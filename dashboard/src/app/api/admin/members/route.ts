...
export async function GET(req: Request) {
    ...
    try {
        ...
        // ⚡ Bolt: Fetch the single most-recent shift per user using distinct + orderBy
        // 🎯 Why: Avoids expensive groupBy followed by findMany with large dynamic OR array
        // 📊 Impact: Reduces query complexity and execution time, eliminates potential massive OR clause limits
