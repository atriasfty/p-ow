...
export async function GET(req: Request) {
    ...
    try {
        ...
        // ⚡ Bolt: Fetch most-recent shift per user using a single query with distinct and orderBy,
        // replacing the anti-pattern of groupBy followed by a large dynamic OR array.
