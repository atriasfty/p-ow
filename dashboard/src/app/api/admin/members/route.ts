...
export async function GET(req: Request) {
    ...
    try {
        ...
        // ⚡ Bolt: Replaced inefficient groupBy + dynamic OR array with a single distinct query
        // Using distinct on userId with orderBy ensures we get the most recent shift efficiently
