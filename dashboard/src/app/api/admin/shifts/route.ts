...
import { getWeekStart as sharedGetWeekStart } from "@/lib/time-windows"
 ...
 */
// getWeekStart / getMidnightInTimezone now live in lib/time-windows.ts as the
// single source of truth across dashboard + bot.
const getWeekStart = sharedGetWeekStart
