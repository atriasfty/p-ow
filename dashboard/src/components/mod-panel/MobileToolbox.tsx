                    ...
                    >
                        <div className="h-10 w-10 rounded-xl flex items-center justify-center flex-shrink-0" style={{ backgroundColor: auto.buttonColor + "1a" }}>
                            {runningId === auto.id ? (
                                ...
                                <Check className="h-5 w-5" style={{ color: auto.buttonColor }} />
                            ) : (
                                <div className="h-3 w-3 rounded-full" style={{ backgroundColor: auto.buttonColor }} />
                            )}
                        </div>
                        <div className="flex-1 text-left">
                            <p className="font-semibold" style={{ color: auto.buttonColor }}>{auto.name}</p>
                            <p className="text-xs text-zinc-500">Custom action</p>
                        </div>
                        <ChevronRight className="h-5 w-5 text-zinc-600" />
                    </button>
                ))}
                ...
                <div className="fixed inset-0 z-50 flex items-end justify-center bg-black/50 backdrop-blur-sm">
                    <div className="w-full max-w-md bg-[#1a1a1a] rounded-t-2xl border-t border-l border-r border-[#333] overflow-hidden shadow-2xl animate-in slide-in-from-bottom">
                        ...
                        <form onSubmit={handlePermLogSubmit} className="p-6 space-y-4">
                            <div>
                                <label htmlFor="m-permission" className="block text-sm font-medium text-zinc-400 mb-2">Permission</label>
                                <input
                                    id="m-permission"
                                    type="text"
                            ...
                            <div>
                                <label htmlFor="m-usernames" className="block text-sm font-medium text-zinc-400 mb-2">Username/s</label>
                                <input
                                    id="m-usernames"
                                    type="text"
                            ...
                            <div>
                                <label htmlFor="m-time" className="block text-sm font-medium text-zinc-400 mb-2">Time</label>
                                <input
                                    id="m-time"
                                    type="text"
                    ...
                    <div className="w-full max-w-md bg-[#1a1a1a] rounded-t-2xl border-t border-l border-r border-[#333] overflow-hidden animate-in slide-in-from-bottom">
                        ...
                        <form onSubmit={handleLoaSubmit} className="p-6 space-y-4">
                            <div className="grid grid-cols-2 gap-4">
                                <div>
                                    <label htmlFor="m-startDate" className="block text-sm font-medium text-zinc-400 mb-2">Start</label>
                                    <input
                                        id="m-startDate"
                                        type="date"
                                        value={startDate}
                                ...
                                <div>
                                    <label htmlFor="m-endDate" className="block text-sm font-medium text-zinc-400 mb-2">End</label>
                                    <input
                                        id="m-endDate"
                                        type="date"
                                        value={endDate}
                            ...
                            <div>
                                <label htmlFor="m-reason" className="block text-sm font-medium text-zinc-400 mb-2">Reason</label>
                                <textarea
                                    id="m-reason"
                                    value={reason}
                ...
                <div className="fixed inset-0 z-50 flex items-end justify-center bg-black/50 backdrop-blur-sm">
                    <div className="w-full max-w-md bg-[#1a1a1a] rounded-t-2xl border-t border-l border-r border-[#333] overflow-hidden shadow-2xl animate-in slide-in-from-bottom">
                        ...
                        <form onSubmit={handleCommandSubmit} className="p-6 space-y-4">
                            <div>
                                <label htmlFor="m-commandInput" className="block text-sm font-medium text-zinc-400 mb-2">Command</label>
                                <input
                                    id="m-commandInput"
                                    type="text"
                                    value={commandInput}
                ...
                <div className="fixed inset-0 z-50 flex items-end justify-center bg-black/60 backdrop-blur-sm">
                    <div className="w-full max-w-md bg-[#1a1a1a] rounded-t-2xl border-t border-l border-r border-[#333] shadow-2xl overflow-hidden animate-in slide-in-from-bottom">
                        ...
                        <form onSubmit={handleStaffRequestSubmit} className="p-6 space-y-4">
                            <div>
                                <label htmlFor="m-staffRequestReason" className="block text-xs font-semibold text-zinc-500 uppercase tracking-wider mb-2">
                                    Reason
                                </label>
                                <textarea
                                    id="m-staffRequestReason"
