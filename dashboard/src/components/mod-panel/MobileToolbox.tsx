                    ...
                    <div className="w-full max-w-md bg-[#1a1a1a] rounded-t-2xl border-t border-l border-r border-[#333] overflow-hidden animate-in slide-in-from-bottom">
                        ...
                        <form onSubmit={handleLoaSubmit} className="p-6 space-y-4">
                            <div className="grid grid-cols-2 gap-4">
                                <div>
                                    <label htmlFor="mobile-startDate" className="block text-sm font-medium text-zinc-400 mb-2">Start</label>
                                    <input
                                        id="mobile-startDate"
                                        type="date"
                                        value={startDate}
                                ...
                                <div>
                                    <label htmlFor="mobile-endDate" className="block text-sm font-medium text-zinc-400 mb-2">End</label>
                                    <input
                                        id="mobile-endDate"
                                        type="date"
                                        value={endDate}
