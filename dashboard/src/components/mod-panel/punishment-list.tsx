                                            ...
                                            (p.type === "Ban Bolo" && permissions.canBanBolo)
                                                ...
                                                <div className="relative" ref={openMenu === p.id ? menuRef : null}>
                                                    <button
                                                        ...
                                                        className="p-1 rounded hover:bg-zinc-700 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:ring-offset-2 focus-visible:ring-offset-[#1a1a1a]"
                                        ...
                                        {editingId === p.id ? (
                                            <div className="flex items-center gap-2">
                                                ...
                                                <button
                                                    ...
                                                    className="p-1 rounded bg-emerald-500/20 text-emerald-500 hover:bg-emerald-500/30 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500 focus-visible:ring-offset-2 focus-visible:ring-offset-[#1a1a1a]"
                                                ...
                                                <button
                                                    ...
                                                    className="p-1 rounded bg-red-500/20 text-red-500 hover:bg-red-500/30 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-500 focus-visible:ring-offset-2 focus-visible:ring-offset-[#1a1a1a]"
