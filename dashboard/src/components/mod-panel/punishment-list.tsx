                                                    ...
                                                    {openMenu === p.id && (
                                                        <div className="absolute right-0 top-6 bg-[#2a2a2a] border border-[#333] rounded-lg shadow-xl z-50 py-1 min-w-[130px]">
                                                            <button
                                                                ...
                                                                className="w-full px-3 py-1.5 text-left text-xs text-zinc-300 hover:bg-zinc-700 focus-visible:outline-none focus-visible:bg-zinc-600 flex items-center gap-2"
                                                            ...
                                                            {p.type === "Ban Bolo" && !p.resolved && (
                                                                <button
                                                                    ...
                                                                    className="w-full px-3 py-1.5 text-left text-xs text-emerald-400 hover:bg-zinc-700 focus-visible:outline-none focus-visible:bg-zinc-600 flex items-center gap-2"
                                                            ...
                                                            <button
                                                                ...
                                                                className="w-full px-3 py-1.5 text-left text-xs text-red-400 hover:bg-zinc-700 focus-visible:outline-none focus-visible:bg-zinc-600 flex items-center gap-2"
