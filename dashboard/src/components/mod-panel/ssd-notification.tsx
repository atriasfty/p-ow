        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm animate-in fade-in duration-200">
            <div className="w-full max-w-md bg-[#1a1a1a] rounded-2xl border border-red-500/30 overflow-hidden shadow-2xl shadow-red-500/10 animate-in zoom-in-95 duration-200">
                <div className="p-8">
                    ...
                    <button
                        onClick={handleDismiss}
                        className="w-full px-6 py-3 rounded-xl font-bold text-sm shadow-lg transition-all transform active:scale-[0.98] bg-red-500 hover:bg-red-600 text-white shadow-red-500/20 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-offset-[#1a1a1a] focus-visible:ring-red-500"
                    >
                        Got it
                    </button>
                </div>
