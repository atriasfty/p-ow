                ...
                <div className="p-8">
                    <div className="flex items-center justify-between mb-6">
                        ...
                        <button
                            ...
                            aria-label="Dismiss shutdown notification"
                    ...
                    <button
                        onClick={handleDismiss}
                        className="w-full px-6 py-3 rounded-xl font-bold text-sm shadow-lg transition-all transform active:scale-[0.98] bg-red-500 hover:bg-red-600 text-white shadow-red-500/20 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-zinc-400 focus-visible:ring-offset-2 focus-visible:ring-offset-[#1a1a1a]"
                    >
                        Got it
                    </button>
                </div>
