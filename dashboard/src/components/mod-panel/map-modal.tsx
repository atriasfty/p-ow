                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div className="flex items-center gap-1 bg-[#111] p-1 rounded-xl border border-white/5">
                            <button
                                ...
                                className="p-2 hover:bg-white/5 rounded-lg text-zinc-400 hover:text-white transition-all shadow-glow-hover focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-zinc-500"
                                aria-label="Zoom out"
                                title="Zoom out"
                            >
                        ...
                        <button
                            onClick={onClose}
                            className="p-3 hover:bg-red-500/10 rounded-xl text-zinc-400 hover:text-red-400 transition-all active:scale-95 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-zinc-500"
