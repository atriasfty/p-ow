                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div className="flex items-center gap-1 bg-[#111] p-1 rounded-xl border border-white/5">
                            <button
                                ...
                                className="p-2 hover:bg-white/5 rounded-lg text-zinc-400 hover:text-white transition-all shadow-glow-hover focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-offset-zinc-900"
                            >
                        ...
                        <button
                            onClick={onClose}
                            aria-label="Close player map modal"
                            className="p-3 hover:bg-red-500/10 rounded-xl text-zinc-400 hover:text-red-400 transition-all active:scale-95 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-offset-zinc-900"
                        >
                            <X className="h-6 w-6" />
                        </button>
                    </div>
