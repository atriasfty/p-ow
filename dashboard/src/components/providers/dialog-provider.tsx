                ...
                >
                    ...
                    >
                        ...
                        <div className="flex justify-end gap-3">
                            ...
                            <button
                                onClick={() => close(true)}
                                className={`px-5 py-2.5 rounded-xl text-sm font-bold transition-colors ${confirmColorMap[dialog.variant]} focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-zinc-900`}
                                autoFocus
                            >
