                ...
                >
                    ...
                    >
                        ...
                        <button
                            ...
                            title="Close dialog"
                            className="absolute top-4 right-4 p-1 rounded-lg text-zinc-500 hover:text-white hover:bg-white/10 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-zinc-400 focus-visible:ring-offset-2 focus-visible:ring-offset-zinc-900"
                        >
                        ...
                        <div className="flex items-center gap-3 mb-4">
                            <div className="h-10 w-10 rounded-xl bg-white/5 flex items-center justify-center shrink-0" aria-hidden="true">
                        ...
                        {/* Message */}
                        <p id="dialog-description" className="text-sm text-zinc-400 leading-relaxed mb-6 pl-[52px]">
                            {dialog.message}
                        </p>
                        ...
                        <div className="flex justify-end gap-3">
                            {dialog.type === "confirm" && (
                                <button
                                    onClick={() => close(false)}
                                    className="px-4 py-2.5 rounded-xl text-sm font-medium text-zinc-300 bg-zinc-800 hover:bg-zinc-700 border border-white/10 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-zinc-400 focus-visible:ring-offset-2 focus-visible:ring-offset-zinc-900"
                                >
                                    {dialog.cancelLabel}
                                </button>
                            )}
                            <button
                                onClick={() => close(true)}
                                className={`px-5 py-2.5 rounded-xl text-sm font-bold transition-colors ${confirmColorMap[dialog.variant]} focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-zinc-400 focus-visible:ring-offset-2 focus-visible:ring-offset-zinc-900`}
                                autoFocus
                            >
