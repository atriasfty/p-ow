                ...
                <div className="absolute z-50 w-full mt-1 bg-[#1a1a1a] border border-[#333] rounded-lg shadow-xl overflow-hidden">
                    ...
                    <div className="max-h-60 overflow-y-auto" role="listbox">
                        {loading ? (
                            ...
                            filteredChannels.map(channel => (
                                <button
                                    ...
                                    className={`w-full flex items-center justify-between px-3 py-2 text-sm hover:bg-white/5 focus-visible:outline-none focus-visible:bg-zinc-700 transition-colors ${value === channel.id ? 'bg-white/5' : ''}`}
                                >
                                    <span className="flex items-center gap-2">
                                        <Hash className="w-3 h-3 text-zinc-500" />
                        ...
                        <button
                            ...
                            className="w-full text-left px-3 py-2 text-xs text-zinc-500 hover:text-zinc-300 hover:bg-white/5 focus-visible:outline-none focus-visible:bg-zinc-700 border-t border-[#2a2a2a]"
                        >
                            Clear Selection
                        </button>
                    </div>
