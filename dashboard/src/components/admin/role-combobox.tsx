                        ...
                        {loading ? (
                            ...
                            filteredRoles.map(role => (
                                <button
                                    ...
                                    className={`w-full flex items-center justify-between px-3 py-2 text-sm hover:bg-white/5 focus-visible:outline-none focus-visible:bg-zinc-700 transition-colors ${value === role.id ? 'bg-white/5' : ''}`}
                                >
                                    <span className="flex items-center gap-2">
                                        <span
                                            className="w-2 h-2 rounded-full"
